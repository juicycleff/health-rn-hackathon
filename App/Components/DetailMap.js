...
import DetailMapCallout from './DetailMapCallout'
import Styles from './Styles/DetailMapStyles'
...
class DetailMap extends React.Component {
  ...
  *************************************************************/
  ...
  renderMapMarkers (location) {
    ...
    * Customize the callout in ./DetailMapCallout.js
    *************************************************************/

    return (
      <MapView.Marker key={location.title} coordinate={{latitude: location.latitude, longitude: location.longitude}}>
        <DetailMapCallout location={location} onPress={this.calloutPress} />
      </MapView.Marker>
    )
  }
